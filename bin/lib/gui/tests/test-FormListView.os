...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("Тест_Должен_УстановитьВидТаблица");
...
Процедура ПриДвойномКлике() Экспорт
	Сообщить("Дабл клик: " + Поле1.ТекущаяСтрока);
КонецПроцедуры

Процедура ПриВыборе() Экспорт
	Сообщить("ПриВыборе: " + Поле1.ТекущаяСтрока);
КонецПроцедуры
...
Процедура Тест_Должен_СоздатьПоле() Экспорт
	...
	Поле1.КолонкаСИндексомИзображения = -1;
	...
	Поле1.Пометки = Истина;
	Поле1.ВыделятьВсюСтроку = Истина;
	Поле1.МножественноеВыделение = ложь;
...
Процедура Тест_Должен_УстановитьВидТаблица() экспорт
	...
	Изображения.Добавить("fixtures/fileroller.ico");
	Изображения.Добавить("fixtures/green-folder.ico");
	Изображения.Добавить("fixtures/fileroller.ico");
...
Процедура Тест_Должен_УправлятьСобытиями() Экспорт
	...
	Поле1.УстановитьДействие(ЭтотОбъект, "ПриНажатииНаКлавишу", "ПолеСпискаПриНажатииНаКлавишу");
...
Процедура ПолеСпискаПриНажатииНаКлавишу() Экспорт
	Сообщить("Нажали: " + Поле1.КодНажатойКлавиши);
КонецПроцедуры